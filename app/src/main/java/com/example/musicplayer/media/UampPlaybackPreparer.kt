...
import com.example.musicplayer.media.extensions.toMediaSource
...
//    private open fun prepareExoPlayerFromFileUri(uri: Uri) {
...
//            e.printStackTrace()
//        }
//        val factory: DataSource.Factory = object : Factory() {
